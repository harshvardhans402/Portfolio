...
const About = () => {
  ...
  useEffect(() => {
    setAbouts([
      ...
      { title: "Java Full Stack", description: "Bringing together MySql, SpringBoot, React to create dynamic web apps. I love using these tools to build responsive and modern websites that users love to explore.", imgUrl: images.about04 }
    ]);
  }, []);
